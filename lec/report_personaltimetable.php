						...
						<div class="panel-body panel-transparent">
							<form method="post" name="f1" action="tcpdf/reports/personaltimetable.php" target="_blank">
								...
								<div class="form-group">                
									...
									<input type="text" class="form-control input-sm" name="start_dte" required placeholder="YYYY-MM-DD">
								</div> 
								<div class="form-group">                
									<label class="control-label"><font color="red">&lowast;</font>End Date </label> 
									<input type="text" class="form-control input-sm" name="end_dte" required placeholder="YYYY-MM-DD">
								</div> 
