...
if(isset($_POST['btn_sele'])){
	...
	echo "<script>
			window.location.href='report_termnote.php?cs=$nm1&curyr=$nm2';
		</script>";
}
					...
					<div class="col-md-8">
						<section class="panel panel-transparent">
							<div class="panel-body panel-transparent">
								...
								?>
									<a href="tcpdf/reports/termnote.php?cs=<?php echo $_GET['cs']; ?>&curyr=<?php echo $_GET['curyr']; ?>&sub=<?php echo $row6['subject_key']; ?>" target="_blank"><button class="btn btn-md btn-success btn-block"><?php echo $row6['subject_name']; ?></button>
									<br>
								<?php
								}			
								?>
